...
class Params:
    ...
    def __init__(self):
        ...
        self.checkpoint_path = os.path.join(str(pathlib.Path(__file__).parent.resolve()).rsplit('/', 3)[0], 'segmentation_checkpoints') # should be right outside the NYU-DL-FINAL folder
        self.dpi = 300
